...
**Constitution is frozen** — change only when running software proves it wrong.
...
**Current state (authoritative):** [SECTION 3 — Current Product State](ux/current-product-state.md) — HCI lock · Continuity · Frozen · Never  
**Experience craft:** [SECTION 3 — Experience Interaction Craft](ux/experience-interaction-craft.md) — G-04 Menu Item Customisation · bridge [Blueprint §3A](ux/LEOS-Studio-Design-Blueprint.md#section-3a--studio--live-experience--guest-interaction-contract)  
**Pillars:** Confidence · Calm · Hospitality · Continuity  
**Sentence:** *LEOS feels like a luxury hotel concierge disguised as software.*

**Principles:** [LEK-040](LEK-040-human-experience-engineering.md)
...
```text
LEOS
├── Experience (Guest) ── “I’m in the right place.”
├── Staff Experience ── “I know my next job.”
└── Studio (Owner)
      ├── Setup   ★ FROZEN v1 — Who → What → Where → How pay → Go Live
      ├── Home    Ready to welcome guests
      ├── Operate Operations Overview (mission control)
      ├── Grow    Trusted manager · almost invisible
      └── Team    Staff · Experiences · Permissions · Devices
```

**UI never says Pack.** Packs are implementation. Humans create an **experience**.
...
One question: **Am I confident?**

### Experience

| Moment | Confidence question | Status |
|--------|---------------------|--------|
| Arrival | Am I in the right place? | ✓ Venue chrome |
| Join | Did I join? Do I know what to do? | ✓ You’re in · place · See the board/menu |
| Browse | Do I know what I can choose? | ✓ Sections · search · + add · **G-04 choices sheet** when required |
| Order | Did they receive it? | ✓ Received banner · concierge timeline |
| Pay | Did I pay? Can I trust this? | ✓ Total · tip · **Mine · Visit · Equal share** · remaining · confirm trust |
| Wait | Are they making it? | ✓ Timeline |
| Receive | Is it ready? | ✓ Ready + timeline |
| Leave / Complete | Am I finished? | ✓ Receipt · Leave · Entry |
| Return | Welcome back? | ✓ One moment after scan · Complete stays calm · short return splash |

### Studio

| Moment | Confidence question | Status |
|--------|---------------------|--------|
| Welcome / Create | Can I start without fear? | ✓ Setup v1 |
| Choose Experience | Do I know what I’m creating? | ✓ Setup v1 |
...
## Milestone 2 — Human Delight

First-time guest: no instructions. First-time business: live QR in under 10 minutes.  
Operate: clear the next thing in one glance. Grow: one breath of truth.

---

## Milestone 1 — Proven (closed)

Restaurant ✓ · Café ✓ · Hotel · Festival · Airport · Healthcare path-proven.
