# UX Design Foundation (index)

**Governed by:** [LEKKI-BUILD](../LEKKI-BUILD.md) · [NORTH-STAR](../NORTH-STAR.md) · [LEK-040 HXE](../LEK-040-human-experience-engineering.md) · [Delivery OS](../LEOS-DELIVERY-SYSTEM.md)
...
| 0e | [Experience Backlog](../EXPERIENCE-BACKLOG.md) | Journey boxes |
| 0h | [LEK-040 HXE](../LEK-040-human-experience-engineering.md) | How LEOS should **feel** — **Frozen** |
| 0v | [LVES](lves.md) | How LEOS should **look** |
| 0p | [LEK-028](../LEK-028-component-catalogue.md) | Components (parts) |
| 0a | [LEOS Delivery OS](../LEOS-DELIVERY-SYSTEM.md) | Design→Contracts→Build→Verify→Release — **Frozen** |
| 0s | [Stories](stories/) | L0–L6 cards · Acceptance Spec |
| 0ss | [Studio screen summaries](studio-screen-summaries.md) · [Studio stories S-00…](stories/README-studio.md) | Per-screen seeds from conversation → stories |
| 0bp | [Studio Design Blueprint](LEOS-Studio-Design-Blueprint.md) | Studio design constitution (v1.2 · **§3A** contract) |
| 0shell | [Studio shell frame evidence](evidence/studio-shell-frame.md) | **Current** — permanent LEKKI frame |
| 0c | [Sprint board](sprint-1-heartbeat.md) | Freeze order |
| 0d | [Platform dashboard](platform-maturity.md) | Maturity bars |
| 0e | [Knowledge](knowledge/README.md) · [Questions](../questions/README.md) | Memory · RFCs |
| 1 | [LEOS Experience Design Principles](LEOS-experience-design-principles.md) | UX constitution |
