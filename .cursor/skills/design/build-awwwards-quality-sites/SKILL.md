...
description: Art-direct distinctive motion-rich Lekki marketing, editorial, and landing pages (GSAP/cinematic OK there). Use when the user asks for Awwwards-quality, cinematic, or motion-led marketing. Do not use for Guest Shell, Studio Setup, Operate, or Grow — those use motion-architect and LVES calm.
---

# Build Awwwards-Quality Sites

## LEOS overlay (read first)

This skill is **marketing / lekki.com / hero only**. Product surfaces follow `motion-architect` and `docs/ux/leos-motion-system.md` (fade/flow/rise/settle, no scroll-story, no Three.js in Studio/Guest/Operate).
